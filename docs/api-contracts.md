...
| Method and route            | Auth   | Request                                       | Response                                                                                                                                                                                                 | Errors                                   |
| --------------------------- | ------ | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `GET /media`                | Bearer | query: `page, pageSize, type[]`               | `200` a page of media across every non-deleted incident, scoped by `orgId`, each item carrying a lightweight incident ref (`{id, sequenceId, title, project}`) — backs the `/galeria` page (roadmap 8.4) | —                                        |
